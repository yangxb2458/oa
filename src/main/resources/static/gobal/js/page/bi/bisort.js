...
var setting1 = {
		...
		callback : {
			onClick : function(e, treeId, treeNode) {
				...
				var levelId = $("#levelId");
				levelId.val(vArr.join(","));
				levelId.attr("data-value",vIdArr.join(","));
			}
		}
};
...
function updateBiSort()
{
	$.ajax({
		url : "/set/biset/updateBiSort",
		type : "post",
		dataType : "json",
		data:{
			sortId:$("#sortId").val(),
