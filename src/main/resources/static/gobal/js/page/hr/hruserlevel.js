$(function() {
	...
	var oc =  $('#chart-container').orgchart({
      'data' : '/ret/hrget/getHrUserLevelChart?levelId=0',
...
function add()
{
	...
	{
		$.ajax({
			url : "/set/hrset/insertHrUserLeave",
			type : "post",
			dataType : "json",
			data:{
...
{
	$.ajax({
		url : "/set/hrset/updateHrUserLeave",
		type : "post",
		dataType : "json",
		data:{
			levelId:$("#levelId").val(),
...
{
	$.ajax({
		url : "/ret/hrget/getHrUserLeaveById",
		type : "post",
		dataType : "json",
		data:{
			levelId:levelId
...
function del()
{
	...
	if (confirm(msg)==true){
		$.ajax({
			url : "/set/hrset/deleteHrUserLeave",
			type : "post",
			dataType : "json",
			data:{
				levelId:$("#levelId").val()
