...
function query() {
	$("#myTable").bootstrapTable({
		url : '/ret/documentget/getMyEntrustList',
		method : 'post',
...
function createEntrust() {
	...
	$.ajax({
		url : '/set/documentset/createEntrust',
		type : "post",
		dataType : "json",
		data : {
			flowId : flowId,
...
function getALlDocumentFlowList() {
	$.ajax({
		url : '/ret/documentget/getMyAllDocumentFlowList',
		type : "post",
		dataType : "json",
		success : function(data) {
			if (data.status == "500") {
...
function stopEntrust(entrustId) {
    ...
    {
	$.ajax({
		url : '/set/documentset/stopEntrust',
		type : "post",
		dataType : "json",
		data : {
			entrustId : entrustId
...
function del(entrustId) {
    ...
    {
	$.ajax({
		url : '/set/documentset/delEntrust',
		type : "post",
		dataType : "json",
		data : {
			entrustId : entrustId
...
function getdocumentFlowInfo(flowId) {
	$.ajax({
