...
function query()
	{
		 $("#myTable").bootstrapTable({
		      url: '/ret/documentget/getDocumentPluginsList',
		      method: 'post',
...
function edit(pluginsId)
{
	...
	$.ajax({
		url : "/ret/documentget/getDocumentPluginsRegisterById",
		type : "post",
		dataType : "json",
		data:{
			pluginsId:pluginsId
	...
	$(".js-save").unbind("click").click(function(){
		$.ajax({
			url : "/set/documentset/updateDocumentPluginsRegister",
			type : "post",
			dataType : "json",
			data:{
				pluginsId:pluginsId,
...
function del(pluginsId)
{
	 if(confirm("确定删除当前插件吗？"))
	    {
	$.ajax({
		url : "/set/documentset/deleteDocumentPluginsRegister",
		type : "post",
		dataType : "json",
		data:{
			pluginsId:pluginsId
...
$(".js-save").unbind("click").click(function(){
	$.ajax({
		url : "/set/documentset/insertDocumentPluginsRegister",
		type : "post",
		dataType : "json",
		data:{
			sortNo:$("#sortNo").val(),
...
function updateStatus(pluginsId,status)
{
	...
	$.ajax({
		url : "/set/documentset/updateDcoucmentPluginsRegister",
		type : "post",
		dataType : "json",
		data:{
			pluginsId:pluginsId,
