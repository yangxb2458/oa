...
function addUnit() {
	$.ajax({
		url : "/set/projectbuildunitset/insertProjectBuildUnit",
		type : "post",
		dataType : "json",
		data : {
			sortNo : $("#sortNo").val(),
...
function updateUnit(unitId) {
	$.ajax({
		url : "/set/projectbuildunitset/updateProjectBuildUnit",
		type : "post",
		dataType : "json",
		data : {
			unitId : unitId,
...
function deleteUnit(unitId) {
	if (confirm("确定删除当前单位吗？")) {
		$.ajax({
			url : "/set/projectbuildunitset/deleteProjectBuildUnit",
			type : "post",
			dataType : "json",
			data : {
				unitId : unitId
...
function query() {
	$("#myTable").bootstrapTable({
		url : '/ret/projectbuildunitget/getProjectBuildUnitList',
		method : 'post',
