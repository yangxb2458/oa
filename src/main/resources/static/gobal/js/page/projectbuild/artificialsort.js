...
var setting = {
	async : {
		...
		url : "/ret/projectbuildartificialget/getProjectBuildArtificialSortTree",// Ajax 获取数据的 URL 地址
...
$(function() {
	$.ajax({
		url : "/ret/projectbuildartificialget/getProjectBuildArtificialSortTree",
		type : "post",
		dataType : "json",
...
function zTreeOnClick(event, treeId, treeNode) {
	$.ajax({
		url : "/ret/projectbuildartificialget/getProjectArtificialSortById",
		type : "post",
		dataType : "json",
		data : {
...
function delErpBomSort() {
	if (confirm("确定删除当前分类吗？")) {
		$.ajax({
			url : "/set/projectbuildartificialset/delProjectBuildArtificialSort",
			type : "post",
			dataType : "json",
			data : {
				sortId : $("#sortId").val()
...
function addsort() {
	$.ajax({
		url : "/set/projectbuildartificialset/insertProjectBuildArtificialSort",
		type : "post",
		dataType : "json",
		data : {
			sortNo : $("#sortNo").val(),
			...
			referenceWage:$("#referenceWage").val(),
...
function updateErpBomSort() {
	$.ajax({
		url : "/set/projectbuildartificialset/updateProjectBuildArtificialSort",
		type : "post",
		dataType : "json",
		data : {
			sortId : $("#sortId").val(),
