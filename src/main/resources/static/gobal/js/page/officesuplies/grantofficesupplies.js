...
function query()
{
	 $("#myTable").bootstrapTable({
	      url: '/ret/officesuppliesget/getGrantOfficeSuppliesList',
	      method: 'post',
...
{
	var html="<a href=\"javascript:void(0);grant('"+suppliesId+"')\" class=\"btn btn-sky btn-xs\" >发放</a>";
	return html;
}

function grant(applyId)
{
$("#grantmodal").modal("show");
document.getElementById("form").reset();
$("#getUser").attr("data-value","");
$(".js-grant").unbind("click").click(function(){
	$.ajax({
		url : "/set/officesuppliesset/insertOfficeSuppliesGrant",
		type : "post",
		dataType : "json",
		data : {
			getUser:$("#getUser").attr("data-value"),
