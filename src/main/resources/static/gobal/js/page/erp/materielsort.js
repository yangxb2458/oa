...
$(function() {
	...
	$("#importbtn").unbind("click").click(function(){
		$("#materielsortimport").modal("show");
		$(".importsave").unbind("click").click(function(){
			importMaterielSort("file");
...
function importMaterielSort(fileId){
	$.ajaxFileUpload({
         url:'/set/erpset/importmaterielsort', //上传文件的服务端
...
function delErpMaterielSort()
{
	  if(confirm("确定删除当前分类吗？"))
	    {
	$.ajax({
		url : "/set/erpset/delErpMaterielSort",
		type : "post",
		dataType : "json",
		data:{
			sortId:$("#sortId").val()
...
{
	$.ajax({
		url : "/set/erpset/insertErpMaterielSort",
		type : "post",
		dataType : "json",
		data:{
			sortNo:$("#sortNo").val(),
...
function updateErpMaterielSort()
{
	$.ajax({
		url : "/set/erpset/updateErpMaterielSort",
		type : "post",
		dataType : "json",
		data:{
			sortId:$("#sortId").val(),
