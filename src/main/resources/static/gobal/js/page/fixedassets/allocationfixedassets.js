...
function query()
	{
		 $("#myTable").bootstrapTable({
		      url: '/ret/fixedassetsget/getAllocationList',
		      method: 'post',
...
{
	var html="<a href=\"javascript:void(0);readdetails('"+assetsId+"','"+applyId+"')\" class=\"btn btn-sky btn-xs\" >详情</a>&nbsp;&nbsp;" +
			"<a href=\"javascript:void(0);allocationfixedassets('"+assetsId+"')\" class=\"btn btn-success btn-xs\" >调拨</a>&nbsp;&nbsp;";
	return html;
}
...
function allocationfixedassets(assetsId)
{
