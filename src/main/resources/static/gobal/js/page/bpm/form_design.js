...
$(".saveform").unbind("click").click(function(){
  var content=editor.getData();
	$.ajax({
	    url:'/set/bpmset/updateBpmFormHtmlCode',
		type:"POST",
		async:false,
...
function importBpmForm()
{
	$.ajaxFileUpload({
        url:'/set/bpmset/importFormHtml?formId='+formId, //上传文件的服务端
...
function formversion()
{
	...
	$(".js-versionsave").unbind("click").click(function(){
		$.ajax({
		    url:'/set/bpmset/setBpmFormVersion',
			type:"POST",
			data:{
				formId:formId,
				title:$("#title").val(),
