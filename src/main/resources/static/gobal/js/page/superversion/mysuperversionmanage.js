...
function query()
	{
		 $("#myTable").bootstrapTable({
		      url: '/ret/superversionget/getSupperversionList',
		      method: 'post',
...
function createOptBtn(superversionId,status)
{
	...
	if(status=="0")
	{
		html+="&nbsp;&nbsp;<a href=\"javascript:void(0);edit('"+superversionId+"')\" class=\"btn btn-magenta btn-xs\" >编辑</a>"
		html+="&nbsp;&nbsp;<a href=\"javascript:void(0);delayApplay('"+superversionId+"');\" class=\"btn btn-purple btn-xs\">延期</a>";
		html+="&nbsp;&nbsp;<a href=\"javascript:void(0);updateStatus('"+superversionId+"','2');\" class=\"btn btn-purple btn-xs\">完成</a>";
	}else if(status=="1")
	{
		html+="&nbsp;&nbsp;<a href=\"javascript:void(0);updateStatus('"+superversionId+"','2');\" class=\"btn btn-purple btn-xs\">完成</a>";
	}
...
function delayApplay(superversionId)
{
...
function updateStatus(superversionId,status)
{
	$.ajax({
...
function edit(superversionId)
{
	open("/app/core/superversion/createsuperverion?view=mysuperverionedit&superversionId="+superversionId,"_self");
}
