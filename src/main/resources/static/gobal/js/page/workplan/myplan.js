...
function query() {
	$("#myTable").bootstrapTable({
		url : '/ret/workplanget/getMyWorkPlanList',
		method : 'post',
...
function createOptBtn(planId,status) {
	...
	if(status=="0")
	{
		html+="<a href=\"javascript:void(0);process('" + planId + "')\" class=\"btn btn-primary btn-xs\">处理</a>&nbsp;&nbsp;";
	}
...
function addProcess(planId)
{
	$.ajax({
		url : "/set/workplanset/insertWorkPlanProcess",
		type : "post",
		dataType : "json",
		data:{
			planId:planId,
