...
function query() {
	$("#myTable").bootstrapTable({
		url : '/ret/workplanget/getHoldWorkPlanList',
		method : 'post',
...
function createOptBtn(planId,status) {
	...
	{
		html = "<a href=\"javascript:void(0);edit('" + planId + "','1')\" class=\"btn btn-primary btn-xs\">完成</a>&nbsp;&nbsp;" 
		html += "<a href=\"javascript:void(0);edit('" + planId + "','2')\" class=\"btn btn-success btn-xs\">挂起</a>&nbsp;&nbsp;" +
				"<a href=\"javascript:void(0);details('" + planId + "')\" class=\"btn btn-sky btn-xs\" >详情</a>";
	}else if(status=="2")
	{
		html = "<a href=\"javascript:void(0);edit('" + planId + "','1')\" class=\"btn btn-primary btn-xs\">完成</a>&nbsp;&nbsp;" 
		html += "<a href=\"javascript:void(0);edit('" + planId + "','0')\" class=\"btn btn-success btn-xs\">开启</a>&nbsp;&nbsp;" +
				"<a href=\"javascript:void(0);details('" + planId + "')\" class=\"btn btn-sky btn-xs\" >详情</a>";
	}else if(status=="1")
	{
