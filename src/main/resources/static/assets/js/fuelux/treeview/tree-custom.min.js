!function(n) {
    ...
    t.prototype = {
        ...
        populate: function(t) {
            ...
            this.options.dataSource.data(t.data(), function(f) {
                ...
                n.each(f.data, function(u, f) {
                    var e, o;
                    "folder" === f.type ? (e = i.$element.find(".tree-folder:eq(0)").clone().show(),
                    e.find(".tree-folder-name").html(f.name),
                    e.find(".tree-loader").html(i.options.loadingHTML),
                    e.find(".tree-folder-header").data(f),
                    e.find('[class*="fa-"]').addClass(f["icon-class"])) : "item" === f.type && (e = i.$element.find(".tree-item:eq(0)").clone().show(),
                    e.find(".tree-item-name").html(f.name),
                    e.data(f));
                    o = f.dataAttributes || [];
        ...
        selectItem: function(t) {
            ...
            }) : u[0] !== i[0] && (u.removeClass("tree-selected").find("i").removeClass("fa fa-check-square-o").addClass("tree-dot"),
            r.push(i.data())),
            this.options.selectable) && (f = "selected",
            i.hasClass("tree-selected") ? (f = "unselected",
            i.removeClass("tree-selected"),
            i.find("i").removeClass("fa fa-check-square-o").addClass("tree-dot")) : (i.addClass("tree-selected"),
        ...
        selectFolder: function(t) {
            ...
            i.find(".fa.fa-folder").length ? (r = "opened",
            u = ".fa.fa-folder",
            f = "fa fa-folder-open",
            e.show(),
            s.children().length || this.populate(i)) : (r = "closed",
            u = ".fa.fa-folder-open",
            f = "fa fa-folder",
            e.hide(),
