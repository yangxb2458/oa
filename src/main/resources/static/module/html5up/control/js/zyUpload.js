			...
			this.createCorePlug = function(){
				var params = {
					...
					onSuccess: function(file, response) {
						...
						$("#uploadInf").append("<div style='width:100px;display:inline-block;text-align: center;margin-left:5px;margin-top:5px;'><img data-value='"+json.redirect+"' width='100px' height='100px' src='/sys/file/getBackgroundImg?fileName="+json.redirect+"'/><a style='cursor: pointer;' onclick='delimg(this)'>删除</a></div>");
						// 根据配置参数确定隐不隐藏上传成功的文件
						if(para.finishDel){
							// 移除效果
							$("#uploadList_" + file.index).fadeOut();
