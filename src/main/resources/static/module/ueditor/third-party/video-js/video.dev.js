 ...
 *
 *   /en-US/docs/JavaScript/Reference/Global_Objects/Object/create
 *
 * @function
...
// First is a plugin reload issue in Firefox that has been around for 11 years: /show_bug.cgi?id=90268
...
// http://  /html5/spec/video.html#dom-media-buffered
...
// http://  /html5/spec/video.html#dom-media-load
vjs.Player.prototype.load = function(){
  this.techCall('load');
  return this;
};

// http://  /html5/spec/video.html#dom-media-currentsrc
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // - Firefox just about always. /show_bug.cgi?id=90268 (might be fixed by version 13)
